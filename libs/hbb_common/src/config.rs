...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.hengan.com"];
pub const PUBLIC_RS_PUB_KEY: &str = "BHC8H+cikFEA88qXACy2s6un5waRv0MoF3zHuuQVC90=";
...
pub mod keys {
    ...
    pub const OPTION_DIRECT_SERVER: &str = "rustdesk.hengan.com";
